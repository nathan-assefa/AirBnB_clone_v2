...
def do_deploy(archive_path):
    ...
    try:
        ...
        no_ext = '/data/web_static/releases/' + arch_file.replace('.tar.gz', '')
        ...
        # We can uncompress the archive from the /tmp/ location to the right place
        ...
        # Let us mv the the contents of the uncompressed file in the right location
